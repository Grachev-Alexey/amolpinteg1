...
--> statement-breakpoint
CREATE TABLE "lptracker_metadata" (
	"id" serial PRIMARY KEY NOT NULL,
	"user_id" varchar NOT NULL,
	"type" varchar NOT NULL,
	"data" jsonb NOT NULL,
...
CREATE TABLE "sync_rules" (
	...
	"webhook_source" varchar NOT NULL,
...
ALTER TABLE "lptracker_metadata" ADD CONSTRAINT "lptracker_metadata_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "lptracker_metadata_user_id_type_unique" ON "lptracker_metadata" USING btree ("user_id","type");--> statement-breakpoint
